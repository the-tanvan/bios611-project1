...
coefi%*%sample
```
Using the model trained by forward/backward selection, I predict the price of the listing linked below. The price was predicited to be \$66.22 which is much lower than the price which is \$175. This suggests that the price of Airbnbs is associated with predictors beyond what I included in my analysis dataset.

Listing used for prediction: https://www.airbnb.com/rooms/34151081

# Further Exploration

To further expand on my analysis, I would incorporate the presence of specific amentities in my model training. It would be interesting to explore if the presence of a full kitchen or a hot tub would increase the price and create a more accurate predictive model for pricing.