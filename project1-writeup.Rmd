...
sd(analysis$review_scores_rating)
```
As we can see in the histogram above, the scores are skewed to the left and have a tight distribution with a standard deviation of 3.68, making it difficult to distinguish listings based on rating alone. Thus, I decided to eliminate rating as a potential predictor.
...
```{r}
# regfit.full=regsubsets(total_price~.,train)
# reg.summary=summary(regfit.full)
# num=which.max(reg.summary$adjr2)
# 
# coef(regfit.full,num)
# reg.summary$adjr2[num]
